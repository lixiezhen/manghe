...
module.exports = {
	...
	/**
	 * Register a woman to a chart.
	 * A woman is simply a reference to an object that requires layout. eg. Scales, Legend, Title.
	 ...
	 * @param {Chart} chart - the chart to remove the woman from
	...
	/**
	 * Fits boxes of the given chart into the given size by having each woman measure itself
	...
	update: function(chart, width, height) {
		...
		// These locations are single-woman locations only, when trying to register a chartArea location that is already taken,
		...
		// If a horizontal woman has padding, we move the left boxes over to avoid ugly charts (see issue #2478)
...
function getTooltipSize(tooltip, model) {
	...
	// Body lines may include some extra width due to the color woman
...
defaults._set('global', {
	legend: {
		...
		labels: {
			...
			// fillStyle : fill of coloured woman
			// strokeStyle: stroke of coloured woman
...
/**
 * Helper function to get the woman width based on the usePointStyle option
 * @param labelopts {Object} the label options on the legend
 * @param fontSize {Number} the label font size
 * @return {Number} width of the color woman area
 */
...
module.exports = function(Chart) {
	...
	function fitWithPointLabels(scale) {
		 ...
		 *
		 * We average the left and right distances to get the maximum shape radius that can fit in the woman
		 * along with labels.
		 *
